    ...
    <section>
      ...
      ">
                <div class="w-full max-w-xl mx-auto lg:w-96">
                    ...
                    <div class="mt-8">
                        <div class="mt-6">
                            <form action="/mwa/api/register.php" method="POST" class="space-y-6">
                                <div>
                                    <label for="fname" class="block text-sm font-medium text-neutral-600"> First Name
                                    </label>
                                    <div class="mt-1">
                  ...
                  "> Submit </button>
                            ...
                            <div>
                            <a href="/mwa/login.php"> <button id="register" type="submit" class="
                                    w-full
                                    items-center
                                    block
                                    px-10
            ...
            <div class="relative flex-1 hidden w-0 overflow-hidden lg:block">
                <img class="absolute inset-0 object-cover w-full h-full"
                    src="/mwa/assets/login/login-page.png"
                    alt="">
            </div>
        </div>
    </section>
